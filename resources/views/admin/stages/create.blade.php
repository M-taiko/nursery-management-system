...
<div class="page-header mb-4" data-aos="fade-down">
    <div class="d-flex align-items-center gap-3">
        ...
        <div>
            <h1 class="page-title"><i class="bi bi-layers-fill me-2 text-primary"></i>إضافة مرحلة جديدة</h1>
            <p class="page-subtitle">تعريف مرحلة دراسية جديدة في الحضانة</p>
        </div>
    </div>
</div>
        ...
        <form action="{{ route('admin.stages.store') }}" method="POST">
            ...
            <div class="glass-card glass-card-no-hover" data-aos="fade-up">
                <div class="card-header">
                    <h6><i class="bi bi-plus-circle me-2 text-primary"></i>بيانات المرحلة</h6>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" name="name"
                                   ...
                                   value="{{ old('name') }}" placeholder="مثال: مرحلة الحضانة" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="age_from"
                                   ...
                                   value="{{ old('age_from', 1) }}" min="0" max="10" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="age_to"
                                   ...
                                   value="{{ old('age_to', 3) }}" min="0" max="10" required>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" rows="3"
                                      ...
                                      placeholder="وصف المرحلة واهدافها...">{{ old('description') }}</textarea>
                        ...
                        <div class="col-12">
                            <div class="form-check">
                                ...
                                <label for="is_active" class="form-check-label fw-600">تفعيل هذه المرحلة</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-footer d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-circle me-1"></i>حفظ المرحلة
                    </button>
                </div>
            </div>
        </form>
